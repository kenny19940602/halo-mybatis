...
import static com.halo.mbg.mapper.TagsDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.halo.mbg.model.Tags;
...
public interface TagsMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, createTime, updateTime, name, slug, slugName, thumbnail);
